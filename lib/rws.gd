...
##  method to determine confluence is called. In particular, if 
##  <pairs2check> is empty, then by the rules guiding the way
##  Knuth Bendix rewriting systems are treated, we know the 
