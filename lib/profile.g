...
##  for all profiled operations, methods and functions. If an argument
...
#############################################################################
##
#F  ProfileFunctions( <funcs>, <names> )
##
##  turns profiling on for all function in <funcs>. At the moment there is
##  no facility by which {\GAP} could determine easily all global functions.
##  Thus there is no easy way to turn profiling on for all global functions
##  at once.
