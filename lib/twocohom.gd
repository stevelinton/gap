...
#O  TwoCocycles( <G>, <M> )
##
##  returns the 2-cocycles of <G> by the <G>-module <M> as vector space over the
##  field underlying <M>.
...
##
##  returns the 2-coboundaries of <G> by the <G>-module <M> as vector space
##  over the field underlying <M>.
...
#O  TwoCohomology( <G>, <M> )
##
##  returns a record defining the second cohomology group as factor of 
##  cocycles by coboundaries.
