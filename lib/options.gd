...
##  a small additional abbreviation of stuff permitted. The full form
...
##  operation, or other function with special syntax. See
##  "ref:function call with options" for details.
##
...
##  effect (unless altered) for all procedures called.
##
##
Revision.options_gd :=
    "@(#)$Id$";
