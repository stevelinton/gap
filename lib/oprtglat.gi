...
local  n,l,o,b,r,p,cl,i,sel,selz,gens,ti,t,tl;
  ...
  while n>0 do
	...
	od;
      ...
      for i in selz do
        p:=RepresentativeOperation(G,dom[i],r.representative,OnPoints);
	if p<>fail then
	  b[i]:=false;
	  n:=n-1;
	  RemoveSet(sel,i);
...
function(G,dom,all)
local  n,l,o,b,r,p,cl,i,sel,selz,gens,ti,t,tl,allcano,cano,can2,p1;
...
function(G,r,all)
local  n,l,o,b,dom,p,cl,i,s,j,t,ti,tl,gens;
