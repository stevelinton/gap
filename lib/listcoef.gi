...
InstallOtherMethod( ProductCoeffs,"left empty",
    true, [ IsList and IsEmpty, IsDenseList ], 0,
function( l1, l2 )
  return [];
end );

InstallOtherMethod( ProductCoeffs,"right empty",
    true, [ IsDenseList, IsList and IsEmpty ], 0,
function( l1, l2 )
  return [];
end );
