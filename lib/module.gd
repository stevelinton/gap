...
##  construction of magma rings (see Chapter~"Magma Rings").
##
...
##
##  Any free left module in the representation `IsRowModuleRep'
...
##
##  Any free left module in the representation `IsMatrixModuleRep'
##  is finite dimensional.
##
InstallTrueMethod( IsFiniteDimensional,
