...
##  decomposition matrices $M_i$ (up to permutations of rows) that satisfy
##  the equation
##  $$
##  M_i^{tr} \cdot X  = `<reducibles>{ <ext>.choice[i] }',
##  $$
##  for a matrix $X$ of irreducible characters,
##  and the value of `choice' is a list of length $n$ whose entries are lists
##  of indices.
##
