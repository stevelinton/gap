...
local l,f,dim,m;
  ...
  f:=arg[Length(arg)];
  l:=Immutable(l);
  List(l,i->ConvertToMatrixRep(i,f));
   ...
   if q then
	...
	Add (qmatrices, newg);
     ...
     if c then
       ...
       List(nmatrices,i->ConvertToMatrixRep(i,F));
