...
##  in particular the field of rationals (see Chapter~"Rationals").
##
...
##  `CharacteristicPolynomial' computes the appropriate power of the minimal
##  polynomial,
...
##  Therefore methods are installed for `CharacteristicPolynomial' that call
##  `TracePolynomial' in the case of field extensions.
##
...
##  Thus $f$ is a generator for the Galois group of $F$,
