...
InstallImmediateMethod( GeneratorsOfMagma,
    IsMagma and HasGeneratorsOfDomain and IsAttributeStoringRep, 0,
    GeneratorsOfDomain );

InstallImmediateMethod( GeneratorsOfMagmaWithOne,
    IsMagmaWithOne and HasGeneratorsOfMagma and IsAttributeStoringRep, 0,
    GeneratorsOfMagma );

InstallImmediateMethod( GeneratorsOfMagmaWithInverses,
    IsMagmaWithInverses and HasGeneratorsOfMagmaWithOne
