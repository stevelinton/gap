...
#T  TestPerm4( <tbl>, <chars>, <modtbl> ) . . . . . . . . . .  test permchars
##
...
##
#T  `TestPerm4' returns the list of all those class functions in the list
#T  <chars> that satisfy (T9), with respect to the Brauer character table
#T  <modtbl>.
##
...
#T DeclareGlobalFunction( "TestPerm4" );
...
#T  Note that `TestPerm4' may be used to prove that certain possible
#T  permutation characters are in fact not permutation characters.
##
