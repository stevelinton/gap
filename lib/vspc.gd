...
##
##  returns a list of the vectors in the row space <V> that have a one in the
##  first nonzero component and are not equal to zero.
##  (This function makes sense only for Gaussian vector spaces.)
##
