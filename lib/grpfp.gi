...
#InstallMethod( ClosureSubgroup, "subgrp fp: Add generator", IsCollsElms,
#  [ IsSubgroupFpGroup and HasParent, IsMultiplicativeElementWithInverse ], 0,
#function( U, elm )
#  return SubgroupNC(FamilyObj(U)!.wholeGroup,
#                    Concatenation(GeneratorsOfGroup(U),[elm]));
#end );

#InstallMethod( ClosureSubgroup, "for subgroup of fp group and elmlist",
#    IsIdenticalObj, [ IsSubgroupFpGroup and HasParent, IsList ], 0,
#function( U, l )
#local i;
#  for i in l do
#    U:=ClosureSubgroup(U,i);
#  od;
#  return U;
#end );
...
local Fgens,	# generators of F
  ...
  e:=ExcludedOrders(F,List(Fgens,i->e));
