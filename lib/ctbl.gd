...
##  Element orders, class lengths, power maps of prime divisors of the group
##  order, automorphisms of <tbl>.
##
...
##  lies in the $j$--th <p>-block of <ordtbl>,
...
#T Date: Thu, 7 Nov 96 14:20:14 +0100
#T From: Juergen Mueller <jmueller@erato.iwr.uni-heidelberg.de>
#T To: sam@math.rwth-aachen.de
#T Subject: PrimeBlocks
#T Cc: jmueller@erato.iwr.uni-heidelberg.de
#T
#T Lieber Thomas,
#T
#T ich habe gerade Deinen Patch f"ur's PrimeBlocks gesehen. Die M"oglichkeit,
#T eine Liste von Charakteren anzugeben, kommt eigentlich durch die Hintert"ur
#T herein. Ich hatte zuna"chst angenommen, das gesamte Programm k"ame mit dem
#T Tafelkopf und der angegebenen Liste von Charakteren aus. Kommt es wohl auch,
#T nur aufgerufen mit einer Menge von Charakteren, die alle in einem Block liegen,
#T gibt es nur dann den richtigen Defekt aus, wenn einer davon H"ohe Null hat.
#T (Also bei abelschen Defektgruppen kein Problem...)
#T
#T Mit [Isaacs], Satz 15.31, findet man aber den Defekt des Blocks aus jedem
#T einzelnen Charakter als das Minimum der Klassendefekte, f"ur die Klassen, auf
#T denen der zentrale Charakter mod p nicht verschwindet. Und die p-modularen
#T Reduktionen der zentralen Charaktere rechnest Du ja ohnehin aus.
#T
#T Was h"alst Du davon? Dann hast Du ein Programm, das wirklich Blockverteilungen
#T und Defekte f"ur beliebige Teilmengen von Charakteren ausrechnet. Vielleicht
#T kann man so etwas ja im Sinne von Brauer zum Berechnen von Charaktertafeln
#T verwenden...
#T
#T Viele Gr"u"se, J"urgen.
...
##  checks the consistency of the following attribute values (if known).
##  \beginlist
##  \item{-}
