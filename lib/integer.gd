...
#C  IsIntegers( <obj> )
##
##  is the defining category for the domain `Integers'.
##
...
##
##  `LogInt' is a method for the general operation `Log'.
##
...
##  because it can not reduce intermediate results like `PowerModInt'.
##
