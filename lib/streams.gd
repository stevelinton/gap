...
##  may also return `fail' if the process is also trying to
##  read. *@input/output processes are not yet implemented@*.
##
...
##  may also return `fail' if the process is also trying to read. Such
