...
#define T_PLIST_FFE             (FIRST_LIST_TNUM+28)
#define LAST_PLIST_TNUM         (T_PLIST_FFE+IMMUTABLE)
#define T_RANGE_NSORT           (FIRST_LIST_TNUM+30)
#define T_RANGE_SSORT           (FIRST_LIST_TNUM+32)
#define T_BLIST                 (FIRST_LIST_TNUM+34)
#define T_BLIST_NSORT           (FIRST_LIST_TNUM+36)
#define T_BLIST_SSORT           (FIRST_LIST_TNUM+38)
#define T_STRING                (FIRST_LIST_TNUM+40)
#define T_STRING_NSORT          (FIRST_LIST_TNUM+42)
#define T_STRING_SSORT          (FIRST_LIST_TNUM+44)
