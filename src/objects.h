...
#define T_PLIST_CYC             (FIRST_LIST_TNUM+26)
#define T_PLIST_CYC_NSORT       (FIRST_LIST_TNUM+28)
#define T_PLIST_CYC_SSORT       (FIRST_LIST_TNUM+30)
#define T_PLIST_FFE             (FIRST_LIST_TNUM+32)
#define LAST_PLIST_TNUM         (T_PLIST_FFE+IMMUTABLE)
#define T_RANGE_NSORT           (FIRST_LIST_TNUM+34)
#define T_RANGE_SSORT           (FIRST_LIST_TNUM+36)
