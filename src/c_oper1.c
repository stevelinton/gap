 ...
 Obj  a_arg )
{
 ...
 CHECK_FUNC_RESULT( t_2 )
 t_1 = (Obj)(UInt)(EQ( INTOBJ_INT(6), t_2 ));
 if ( t_1 ) {
  ...
  CHANGED_BAG( t_2 );
  C_ELM_LIST_FPL( t_3, a_arg, INTOBJ_INT(4) )
  SET_ELM_PLIST( t_2, 4, t_3 );
  CHANGED_BAG( t_2 );
  C_ELM_LIST_FPL( t_3, a_arg, INTOBJ_INT(5) )
  SET_ELM_PLIST( t_2, 5, t_3 );
  CHANGED_BAG( t_2 );
  C_ELM_LIST_FPL( t_3, a_arg, INTOBJ_INT(6) )
 ...
 /* elif 5 = LEN_LIST( arg ) then */
  ...
  t_2 = CALL_1ARGS( t_3, a_arg );
  CHECK_FUNC_RESULT( t_2 )
  t_1 = (Obj)(UInt)(EQ( INTOBJ_INT(5), t_2 ));
  if ( t_1 ) {
  ...
  /* else */
   ...
   /* Error( "usage: InstallMethod( <opr>, <rel>, <fil>, <rk>, <method>) for ", NAME_FUNC( arg[1] ) ); */
   t_1 = GF_Error;
   C_NEW_STRING( t_2, 63, "usage: InstallMethod( <opr>, <rel>, <fil>, <rk>, <method>) for " )
   t_4 = GF_NAME__FUNC;
 ...
 Obj  a_arg )
{
 ...
 /* elif 5 = LEN_LIST( arg ) then */
  ...
  /* else */
   ...
   /* Error( "usage: InstallOtherMethod( <opr>, <rel>, <fil>, <rk>, ", "<method> ) for ", NAME_FUNC( arg[1] ) ); */
   t_1 = GF_Error;
   C_NEW_STRING( t_2, 54, "usage: InstallOtherMethod( <opr>, <rel>, <fil>, <rk>, " )
   C_NEW_STRING( t_3, 15, "<method> ) for " )
   t_5 = GF_NAME__FUNC;
   C_ELM_LIST_FPL( t_6, a_arg, INTOBJ_INT(1) )
 ...
 Obj  args )
{
 ...
 a_opr = ELM_PLIST( args, 1 );
 a_info = ELM_PLIST( args, 2 );
 a_rel = ELM_PLIST( args, 3 );
 a_filters = ELM_PLIST( args, 4 );
 a_rank = ELM_PLIST( args, 5 );
 a_method = ELM_PLIST( args, 6 );
 a_check = ELM_PLIST( args, 7 );
 ...
 /* if FLAGS_FILTER( opr ) <> false and (rel = true or rel = RETURN_TRUE) and LEN_LIST( filters ) = 1 and (method = true or method = RETURN_TRUE) then */
 t_6 = GF_FLAGS__FILTER;
 t_5 = CALL_1ARGS( t_6, a_opr );
 CHECK_FUNC_RESULT( t_5 )
 t_6 = False;
 ...
 if ( t_3 ) {
  t_7 = True;
  t_6 = (Obj)(UInt)(EQ( a_rel, t_7 ));
  t_5 = t_6;
  if ( ! t_5 ) {
   t_8 = GC_RETURN__TRUE;
   CHECK_BOUND( t_8, "RETURN_TRUE" )
   t_7 = (Obj)(UInt)(EQ( a_rel, t_8 ));
   t_5 = t_7;
  }
  t_3 = t_5;
 }
 ...
 if ( t_1 ) {
  t_5 = True;
  t_4 = (Obj)(UInt)(EQ( a_method, t_5 ));
  t_3 = t_4;
  if ( ! t_3 ) {
   t_6 = GC_RETURN__TRUE;
   CHECK_BOUND( t_6, "RETURN_TRUE" )
   t_5 = (Obj)(UInt)(EQ( a_method, t_6 ));
   t_3 = t_5;
  }
  t_1 = t_3;
 }
 ...
 t_3 = False;
 t_2 = (Obj)(UInt)( ! EQ( a_info, t_3 ));
 t_1 = t_2;
 if ( t_1 ) {
  t_6 = GF_IS__STRING;
  t_5 = CALL_1ARGS( t_6, a_info );
  CHECK_FUNC_RESULT( t_5 )
  CHECK_BOOL( t_5 )
  t_4 = (Obj)(UInt)(t_5 != False);
  t_3 = (Obj)(UInt)( ! ((Int)t_4) );
 ...
 if ( t_1 ) {
  ...
  t_2 = CALL_1ARGS( t_3, a_opr );
  CHECK_FUNC_RESULT( t_2 )
  C_NEW_STRING( t_3, 36, ": <info> must be a string or `false'" )
  CALL_2ARGS( t_1, t_2, t_3 );
 ...
 CALL_6ARGS( t_1, a_opr, a_info, a_rel, l_flags, a_rank, a_method );
 ...
 Obj  a_arg )
{
 ...
 while ( 1 ) {
  ...
  /* re := re or IsBound( cond[i]) and not Tester( cond[i] )( arg[i] ) and cond[i]( arg[i] ); */
  t_7 = OBJ_LVAR_1UP( 4 );
  CHECK_BOUND( t_7, "re" )
  CHECK_BOOL( t_7 )
  t_6 = (Obj)(UInt)(t_7 != False);
  ...
  if ( t_5 == False ) {
   t_11 = OBJ_LVAR_1UP( 3 );
   CHECK_BOUND( t_11, "cond" )
   t_12 = OBJ_LVAR_1UP( 5 );
   CHECK_BOUND( t_12, "i" )
   CHECK_INT_POS( t_12 )
   t_10 = C_ISB_LIST( t_11, t_12 );
   t_9 = (Obj)(UInt)(t_10 != False);
   t_8 = t_9;
   if ( t_8 ) {
    t_14 = GF_Tester;
    t_16 = OBJ_LVAR_1UP( 3 );
    CHECK_BOUND( t_16, "cond" )
    t_17 = OBJ_LVAR_1UP( 5 );
    CHECK_BOUND( t_17, "i" )
    CHECK_INT_POS( t_17 )
    C_ELM_LIST_FPL( t_15, t_16, t_17 )
    ...
    CHECK_BOUND( t_15, "i" )
    CHECK_INT_POS( t_15 )
    C_ELM_LIST_FPL( t_14, a_arg, t_15 )
    t_12 = CALL_1ARGS( t_13, t_14 );
    CHECK_FUNC_RESULT( t_12 )
    CHECK_BOOL( t_12 )
    t_11 = (Obj)(UInt)(t_12 != False);
    t_10 = (Obj)(UInt)( ! ((Int)t_11) );
    t_8 = t_10;
   }
   t_7 = t_8;
   if ( t_7 ) {
 ...
 Obj  self )
{
 ...
 /* BIND_GLOBAL( "INSTALL_METHOD", function ( opr, info, rel, filters, rank, method, check )
      local  tmp, req, reqs, match, i, j, k, imp, flags, notmatch;
      if not IS_OPERATION( opr )  then
          Error( "<opr> is not an operation" );
      fi;
      if FLAGS_FILTER( opr ) <> false and (rel = true or rel = RETURN_TRUE) and LEN_LIST( filters ) = 1 and (method = true or method = RETURN_TRUE)  then
...
static Int InitKernel ( StructInitInfo * module )
{
 ...
 /* information for the functions */
 InitGlobalBag( &DefaultName, "oper1.g:DefaultName(32494742)" );
 InitHandlerFunc( HdlrFunc1, "oper1.g:HdlrFunc1(32494742)" );
 InitGlobalBag( &(NameFunc[1]), "oper1.g:NameFunc[1](32494742)" );
 InitHandlerFunc( HdlrFunc2, "oper1.g:HdlrFunc2(32494742)" );
 InitGlobalBag( &(NameFunc[2]), "oper1.g:NameFunc[2](32494742)" );
 InitHandlerFunc( HdlrFunc3, "oper1.g:HdlrFunc3(32494742)" );
 InitGlobalBag( &(NameFunc[3]), "oper1.g:NameFunc[3](32494742)" );
 InitHandlerFunc( HdlrFunc4, "oper1.g:HdlrFunc4(32494742)" );
 InitGlobalBag( &(NameFunc[4]), "oper1.g:NameFunc[4](32494742)" );
 InitHandlerFunc( HdlrFunc5, "oper1.g:HdlrFunc5(32494742)" );
 InitGlobalBag( &(NameFunc[5]), "oper1.g:NameFunc[5](32494742)" );
 InitHandlerFunc( HdlrFunc6, "oper1.g:HdlrFunc6(32494742)" );
 InitGlobalBag( &(NameFunc[6]), "oper1.g:NameFunc[6](32494742)" );
 InitHandlerFunc( HdlrFunc7, "oper1.g:HdlrFunc7(32494742)" );
 InitGlobalBag( &(NameFunc[7]), "oper1.g:NameFunc[7](32494742)" );
 InitHandlerFunc( HdlrFunc8, "oper1.g:HdlrFunc8(32494742)" );
 InitGlobalBag( &(NameFunc[8]), "oper1.g:NameFunc[8](32494742)" );
 InitHandlerFunc( HdlrFunc9, "oper1.g:HdlrFunc9(32494742)" );
 InitGlobalBag( &(NameFunc[9]), "oper1.g:NameFunc[9](32494742)" );
 InitHandlerFunc( HdlrFunc10, "oper1.g:HdlrFunc10(32494742)" );
 InitGlobalBag( &(NameFunc[10]), "oper1.g:NameFunc[10](32494742)" );
 InitHandlerFunc( HdlrFunc11, "oper1.g:HdlrFunc11(32494742)" );
 InitGlobalBag( &(NameFunc[11]), "oper1.g:NameFunc[11](32494742)" );
 InitHandlerFunc( HdlrFunc12, "oper1.g:HdlrFunc12(32494742)" );
 InitGlobalBag( &(NameFunc[12]), "oper1.g:NameFunc[12](32494742)" );
 InitHandlerFunc( HdlrFunc13, "oper1.g:HdlrFunc13(32494742)" );
 InitGlobalBag( &(NameFunc[13]), "oper1.g:NameFunc[13](32494742)" );
 InitHandlerFunc( HdlrFunc14, "oper1.g:HdlrFunc14(32494742)" );
 InitGlobalBag( &(NameFunc[14]), "oper1.g:NameFunc[14](32494742)" );
 InitHandlerFunc( HdlrFunc15, "oper1.g:HdlrFunc15(32494742)" );
 InitGlobalBag( &(NameFunc[15]), "oper1.g:NameFunc[15](32494742)" );
 InitHandlerFunc( HdlrFunc16, "oper1.g:HdlrFunc16(32494742)" );
 InitGlobalBag( &(NameFunc[16]), "oper1.g:NameFunc[16](32494742)" );
